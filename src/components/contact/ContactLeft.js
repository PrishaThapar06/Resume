    ...
    return (
        <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-between">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-lg font-normal text-gray-400">FrontEnd Developer & Programmer</p>
                ...
                <p className="text-base text-gray-400 flex items-center gap-2">Email: <span className="text-lightText">prisha.thapar06@gmail.com</span></p>
              </div>
              <div className="flex flex-col gap-4">
