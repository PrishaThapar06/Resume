         ...
         <div className="w-full">
          <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
            ...
            <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
              ...
              <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                ...
                <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                  this is the review from my clients based on my performance over the time period i worked under them . i hope this gives you assurance of my potential and capabilities to work hard . i hope to get a chance in a reputated company like yours .
                </p>
              </div>
            </div>
          </div>
